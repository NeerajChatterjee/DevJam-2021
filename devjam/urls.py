...
urlpatterns = [
    ...
    path('login/',auth_views.LoginView.as_view(template_name='devjam/login.html'),name='login'),
    path('logout/',auth_views.LogoutView.as_view(template_name='devjam/logout.html'),name='logout'),
